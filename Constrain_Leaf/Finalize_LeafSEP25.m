...
load('Constrained_unblocked_SEP25_Final.mat')
model.metFormulas={};
...
model.metCharges = num2cell(zeros(length(model.mets), 1));
...
pos=find(contains(model.mets,{'CPD-13612'}));
model.metFormulas(pos)={'C18H40NO2'};
model.metCharges(pos)={1};
pos2=find(contains(model.mets,'CPD-649'));
model.metFormulas(pos2)={'C18H39NO5P'};
model.metCharges(pos2)={-1};
...
save('35deads_withsubsystemsSEP25.mat','model')
